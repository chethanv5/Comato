...
fun CheckboxComponent(value: String) {
    ...
    Row(modifier = Modifier.fillMaxWidth().heightIn(45.dp).padding(start = 16.dp, end = 16.dp)) {
        ...
        Text(value, Modifier.padding(start = 2.dp, top = 11.dp, end = 2.dp),
            fontSize = 11.sp)
        ...
        }, fontSize = 11.sp, color = Color.Blue)

        Text("and", Modifier.padding(2.dp, top = 11.dp, end = 2.dp), fontSize = 11.sp)

        Text("Term",Modifier.padding(top = 11.dp).clickable{
            Toast.makeText(context,"Terms and Conditions",Toast.LENGTH_SHORT).show()
        }, fontSize = 11.sp, color = Color.Blue)
    }
